...
<template>
    <main class="flex justify-center flex-col container max-w-7xl m-auto p-4">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 lg:grid-rows-2 gap-6 mt-6 lg:max-h-100">
            <IngredientsPanel/>
            <PortionsPanel/>
            <TimePanel/>
            <ComplexityPanel/>
